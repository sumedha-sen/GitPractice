...
import com.tyss.ems2.bean.Employee;
...
public class App {
    ...
    {      
    	while(true) {
    		...
    		System.out.println("without jpql queries ");
	    		   ...
	    		   if(option==1) {
	        	       ...
	        	       EntityManagerFactory managerFactory=null;
	        			...
	        			try {
	        				...
	        				transaction.begin();
	        				Employee emp = entityManager.find(Employee.class, idvalue);
	        			
	        				if (emp!=null) {
	        					emp.setName(namevalue);
	        				}
